...
<div class="findings reveal">
  ...
  <div class="findings-grid">
    <div class="finding-card">
      ...
      <div class="finding-detail">All 6 judges independently gave Ruka Hirano <strong>identical 90s</strong> — on two separate runs with <strong>different tricks</strong>.</div>
    </div>
    <div class="finding-card">
      <div class="finding-icon">💥</div>
