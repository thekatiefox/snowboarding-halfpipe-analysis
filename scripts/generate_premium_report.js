...
<div class="findings reveal">
  ...
  <div class="findings-grid">
    <div class="finding-card">
      ...
      <div class="finding-detail">In a subjective sport, all 6 judges independently gave Ruka Hirano <strong>identical 90s</strong> — twice, on runs with <strong>different tricks</strong>. The closest any other run got was a 1-point spread.</div>
    </div>
    <div class="finding-card">
      <div class="finding-icon">💥</div>
